...
def transformer_app(train_data_dfs, train_label_df, val_data_dfs, val_label_df, test_data_dfs, test_label_df):    
    ...
    print(counts)
    print(counts2)
    print(counts3/sum(counts2))
    print(counts4/sum(counts2))            
...
if __name__ == "__main__":
    ...
    y_train = pd.read_csv(data_directory + '/y_train_s2.csv').drop('Unnamed: 0', axis = 1)
    X_val = pd.read_csv(data_directory + '/X_val_s2.csv').drop('Unnamed: 0', axis = 1)
    y_val = pd.read_csv(data_directory + '/y_val_s2.csv').drop('Unnamed: 0', axis = 1)
    X_test = pd.read_csv(data_directory + '/X_test_s2.csv').drop('Unnamed: 0', axis = 1)
    y_test = pd.read_csv(data_directory + '/y_test_s2.csv').drop('Unnamed: 0', axis = 1)
