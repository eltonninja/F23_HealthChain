...
def extract_visit_data(entries, patient_to_visits_map, patient_static_data):
...
def save_patient_data_to_csv(patient_to_visits_map, patient_static_data, output_dir):
    for patient_id, visits in patient_to_visits_map.items():
        ...
        col_order = ['visit_date', 'male', 'female', 'age_o'] + [col for col in patient_df if col not in ['visit_date', 'male', 'female', 'age']]
...
def process_fhir_directory(input_dir, output_dir):
    ...
    for file_name in os.listdir(input_dir):
        ...
        extract_visit_data(entries, patient_to_visits_map, patient_static_data)
