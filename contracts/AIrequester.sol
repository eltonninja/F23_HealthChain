...
/**
 * Might not be needed based on implementation changes
 * We may not want this on the blockchain due to the risk of putting the medical records on the blockchain
 */
